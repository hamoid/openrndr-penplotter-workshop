...
fun main() {
    ...
    * `anchor` a `Vector2` instance representing the current anchor
    ...
    @Media.Image "../media/shapes-006.png"

    @Application
    @ProduceScreenshot("media/shapes-006.png")
    @Code
    application {
        @Exclude
        configure {
    ...
    @Media.Image "../media/shapes-contour-rectified-001.png"

    @Application
    @ProduceScreenshot("media/shapes-contour-rectified-001.png")
    @Code
    application {
        @Exclude
        configure {
    ...
    @Media.Image "../media/shapes-intersections-001.png"

    @Application
    @ProduceScreenshot("media/shapes-intersections-001.png")
    @Code
    application {
        @Exclude
        configure {
