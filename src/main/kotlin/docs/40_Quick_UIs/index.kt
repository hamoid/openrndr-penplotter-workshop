...
fun main() {
    ...
    @Application
    @ProduceScreenshot("media/quick-ui-003.png")
    @Code
    application {
        @Exclude
        configure {
    ...
    @Media.Image "../media/quick-ui-003.png"
    ...
    @Application
    @ProduceScreenshot("media/quick-ui-004.png")
    @Code
    application {
        @Exclude
        configure {
    ...
    @Media.Image "../media/quick-ui-004.png"
    ...
    @Application
    @ProduceScreenshot("media/quick-ui-005.png")
    @Code
    application {
        @Exclude
        configure {
    ...
    @Media.Image "../media/quick-ui-005.png"
